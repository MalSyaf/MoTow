package com.example.motow.test;
...
import com.example.motow.BuildConfig;
...
public class TestCoordinate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView coordinate = findViewById(R.id.coordinate);
        ...
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(@NonNull LocationResult locationResult) {
                ...
                coordinate.setText("Location : " + latitude +", "+ longitude);

            }
        };
        mLocationRequest = LocationRequest.create()
                .setInterval(UPDATE_INTERVAL)
                .setFastestInterval(FATEST_UPDATE)
