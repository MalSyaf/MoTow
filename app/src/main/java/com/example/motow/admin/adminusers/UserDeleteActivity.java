...
import com.example.motow.databinding.ActivityUserDeleteBinding;
...
public class UserDeleteActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, UserListener {
    ...
    private void setRecyclerView() {
        binding.deletionRecycler.setHasFixedSize(true);
        binding.deletionRecycler.setLayoutManager(new LinearLayoutManager(this));
        users = new ArrayList<>();
    ...
    private void getUsers() {
        ...
        db.collection("Users").whereEqualTo("delRequest", "1")
                .get()
